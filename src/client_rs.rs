...
use hyper::{body::Body, Request, Response, Method, Uri};
...
pub struct ApiClient {
    ...
    connector: HttpsConnector<hyper_util::client::legacy::connect::HttpConnector>,
}
...
impl ApiClient {
    ...
    pub async fn execute_request(&self, mut request: Request<Body>) -> Result<Response<Incoming>> {
    ...
    async fn execute_single_request(&self, request: &Request<Body>) -> Result<Response<Incoming>> {
